...
class _$StreamItem extends StreamItem {
  ...
  factory _$StreamItem([void Function(StreamItemBuilder)? updates]) =>
      (StreamItemBuilder()..update(updates))._build();
  ...
  @override
  StreamItemBuilder toBuilder() => StreamItemBuilder()..replace(this);
  ...
  _$StreamItem _build() {
    final _$result = _$v ??
        _$StreamItem._(
          ...
          url: BuiltValueNullFieldError.checkNotNull(url, r'StreamItem', 'url'),
          views: views,
          isShort: isShort,
