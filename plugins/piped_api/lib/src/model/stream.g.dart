...
final BuiltSet<StreamFormatEnum> _$streamFormatEnumValues =
    BuiltSet<StreamFormatEnum>(const <StreamFormatEnum>[
...
class _$Stream extends Stream {
  ...
  factory _$Stream([void Function(StreamBuilder)? updates]) =>
      (StreamBuilder()..update(updates))._build();
  ...
  @override
  StreamBuilder toBuilder() => StreamBuilder()..replace(this);
